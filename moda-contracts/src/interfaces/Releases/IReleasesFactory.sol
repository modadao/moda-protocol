...
interface IReleasesFactory {
    ...
    /**
     * @dev Creates a new releases contract clone using openzeppelin's Clones library.
     * The caller becomes the owner and default admin of the new releases contract.
