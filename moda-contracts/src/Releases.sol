    ...
    ERC2981Upgradeable
{
    ...
    function create(
        ...
        for (uint256 i = 0; i < trackIds.length; i++) {
            beneficiaries[i] = ITrackRegistration(_catalog).getTrack(trackIds[i]).trackBeneficiary;
        }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC1155Upgradeable, ERC2981Upgradeable, AccessControlUpgradeable, ERC1155HolderUpgradeable)
        returns (bool)
    {
